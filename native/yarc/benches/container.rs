...
const BYTE_PAYLOAD_SIZE: usize = 64 * MIB;
...
fn bench_archive_extract_dir(c: &mut Criterion) {
    let runtime = runtime();
    let mut group = c.benchmark_group("container_directory");
